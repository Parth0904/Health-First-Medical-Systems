...
export default function WhatsAppButton() {
  return (
    ...
    >
      <span className="absolute right-16 whitespace-nowrap bg-slate-900 text-white text-xs px-3 py-2 rounded-xl opacity-0 group-hover:opacity-100 transition-all duration-300">
        Chat on WhatsApp
      </span>
      <FaWhatsapp size={28} />
    </a>
