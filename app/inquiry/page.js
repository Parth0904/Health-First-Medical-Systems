...
export default function InquiryPage() {
    ...
    const [loading, setLoading] = useState(false); // Added missing state variable to prevent crashes
                                                ...
                                                <div className="space-y-6">
                                                    <div>
                                                        ...
                                                        <input
                                                            ...
                                                            className="w-full rounded-2xl border border-gray-200 bg-white/80 px-5 py-4 text-gray-808 placeholder:text-gray-400 outline-none focus:ring-4 focus:ring-blue-100 focus:border-blue-500 transition-all duration-300"
                                                        />
                                                    </div>
